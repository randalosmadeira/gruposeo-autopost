...
import { MAX_PIPELINE_ATTEMPTS, type SupporterAvatarJobData } from './supporter-avatar/pipeline.js';

export const CONTENT_QUEUE_NAME='zica-content';
export const INDEX_QUEUE_NAME='zica-index-flush';
export const SUPPORTER_AVATAR_QUEUE_NAME='zica-supporter-avatar';
...
export const supporterAvatarQueue=new Queue<SupporterAvatarJobData>(SUPPORTER_AVATAR_QUEUE_NAME,{connection:redis});
