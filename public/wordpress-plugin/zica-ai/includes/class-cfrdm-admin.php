        ...
        <div class="wrap cfrdm-wrap">
            ...
            <div class="cfrdm-news-alert">
                ...
                <div class="cfrdm-news-item <?php echo esc_attr($news->news_type); ?>" data-news-id="<?php echo $news->id; ?>">
                    ...
                    <button type="button" class="cfrdm-dismiss-news" title="<?php _e('Dispensar', 'zica-ai'); ?>">
                    ...
                    <div class="cfrdm-card-body">
                        ...
                        <div class="cfrdm-api-key-box">
                            ...
                            <div class="api-key-field">
                                ...
                                <button type="button" class="button" id="cfrdm-copy-key" title="<?php _e('Copiar', 'zica-ai'); ?>">
                    ...
                    <div class="cfrdm-card-body">
                        ...
                        <div class="notice notice-info inline" style="margin:15px 0 0;">
                            ...
                            <ol style="margin:5px 0 0 20px;">
                                ...
                                <li><?php _e('Adicione como URI de redirecionamento:', 'zica-ai'); ?> <code><?php echo admin_url('admin.php?page=cfrdm-gsc-auth'); ?></code></li>
                            </ol>
                        </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="column-title column-primary">
                                ...
                                <div class="row-actions">
                                    ...
                                    <span class="analyze">
                                        <a href="#" class="cfrdm-analyze-post" data-post-id="<?php echo $post_id; ?>"><?php _e('Analisar SEO', 'zica-ai'); ?></a>
                                    </span>
                                </div>
                            </td>
