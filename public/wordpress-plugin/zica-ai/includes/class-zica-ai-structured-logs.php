...
class ZICA_AI_Structured_Logs {
    ...
    public static function get_table_name() {
        ...
        if (defined('ZICA_AI_STRUCTURED_LOGS_TABLE')) {
            return $wpdb->prefix . ZICA_AI_STRUCTURED_LOGS_TABLE;
        }
    ...
    public static function create_table() {
        ...
        ZICA_AI_Logger::success('structured_logs', 'Tabela de logs estruturados criada/atualizada');
    }
    ...
    public static function insert($data) {
        ...
        if ($result === false) {
            ZICA_AI_Logger::error('structured_logs', 'Falha ao inserir log', array(
    ...
    public static function cleanup($days = null) {
        ...
        if ($deleted > 0) {
            ZICA_AI_Logger::info('structured_logs', "Limpeza de logs: {$deleted} registros removidos", array(
                'days' => $days,
