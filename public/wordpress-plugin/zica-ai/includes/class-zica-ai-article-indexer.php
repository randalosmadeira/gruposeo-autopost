 ...
 * with the Zica.ai platform for intelligent internal linking.
 * 
 * @package Zica.ai_RDM
 * @since 2.6.0
 */
...
class ZICA_AI_Article_Indexer {
    ...
    public function register_rest_routes() {
        ...
        register_rest_route('zica-ai/v1', '/trigger-sync', array(
            'methods' => 'POST',
        ...
        register_rest_route('zica-ai/v1', '/articles-for-indexing', array(
            'methods' => 'GET',
        ...
        register_rest_route('zica-ai/v1', '/article-content/(?P<id>\d+)', array(
            'methods' => 'GET',
        ...
        register_rest_route('zica-ai/v1', '/export-articles-batch', array(
            'methods' => 'POST',
    ...
    /**
     * Send articles to the Zica.ai platform
     */
...
add_action('cfrdm_sync_single_article', function($post_id) {
    $indexer = new ZICA_AI_Article_Indexer();
    $post = get_post($post_id);
    ...
    if ($post && $post->post_status === 'publish') {
        ...
        $method = new ReflectionMethod('ZICA_AI_Article_Indexer', 'send_to_platform');
