        ...
        <div id="cfrdm-account-modal" class="cfrdm-modal" style="display: none;">
            <div class="cfrdm-modal-content">
                ...
                <div class="cfrdm-modal-footer">
                    <button type="button" class="button" id="cfrdm-modal-cancel"><?php _e('Cancelar', 'zica-ai'); ?></button>
                    <button type="button" class="button button-primary" id="cfrdm-save-account"><?php _e('Salvar Conta', 'zica-ai'); ?></button>
                </div>
            </div>
        </div>
