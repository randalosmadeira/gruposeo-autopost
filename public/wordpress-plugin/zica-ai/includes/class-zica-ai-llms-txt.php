...
class ZICA_AI_LLMS_Txt {
    ...
    public function register_rest_routes() {
        register_rest_route('zica-ai/v1', '/llms-txt/regenerate', array(
            'methods' => 'POST',
            'callback' => array($this, 'rest_regenerate'),
            'permission_callback' => array('ZICA_AI_API', 'verify_api_key'),
        ));
        
        register_rest_route('zica-ai/v1', '/llms-txt/status', array(
            'methods' => 'GET',
