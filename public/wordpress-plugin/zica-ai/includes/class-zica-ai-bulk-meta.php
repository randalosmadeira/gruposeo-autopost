...
class ZICA_AI_Bulk_Meta {
    ...
    public function register_routes() {
        register_rest_route('zica-ai/v1', '/bulk-meta-update', array(
            'methods'  => 'POST',
            'callback' => array($this, 'handle_bulk_update'),
            'permission_callback' => array($this, 'check_permission'),
        ));

        register_rest_route('zica-ai/v1', '/seo-plugin-info', array(
            'methods'  => 'GET',
            'callback' => array($this, 'get_seo_plugin_info'),
            'permission_callback' => array($this, 'check_permission'),
        ));

        register_rest_route('zica-ai/v1', '/readability-analysis', array(
            'methods'  => 'POST',
    ...
    public function handle_bulk_update($request) {
        ...
        if (class_exists('ZICA_AI_Structured_Logs')) {
            ZICA_AI_Structured_Logs::log(null, null, null, null, 'completed', 'bulk_meta',
