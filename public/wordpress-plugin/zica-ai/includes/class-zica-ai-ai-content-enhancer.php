...
class ZICA_AI_AI_Content_Enhancer {
    ...
    public static function queue_recreation($url, $context = array()) {
        ...
        if ($post_id && class_exists('ZICA_AI_AI_Auto_Fix')) {
...
Retorne APENAS o HTML do conteúdo expandido, sem explicações.";
        ...
        try {
            ...
            ZICA_AI_Logger::success('content_enhance', 'Conteúdo expandido', array(
                'post_id' => $post_id,
            ...
            ZICA_AI_Logger::error('content_enhance', 'Erro ao expandir conteúdo', array(
                'post_id' => $post_id,
                'error' => $e->getMessage(),
            ));
    ...
    public function add_content_sections($post_id, $sections = array('faq')) {
        ...
        if (!empty($sections_added)) {
            ...
            ZICA_AI_Logger::success('content_enhance', 'Seções adicionadas', array(
                'post_id' => $post_id,
    ...
    private function generate_section($title, $existing_content, $section_type) {
        ...
        try {
            ...
            ZICA_AI_Logger::error('content_enhance', 'Erro ao gerar seção', array(
