...
class ZICA_AI_Diagnostics {
    ...
    public static function get_report() {
        ...
        if (class_exists('ZICA_AI_Method_Validator')) {
            $method_validation = ZICA_AI_Method_Validator::get_report();
        ...
        return array(
            ...
            'environment' => array(
                'plugin_version' => defined('ZICA_AI_VERSION') ? ZICA_AI_VERSION : null,
    ...
    private static function check_tables() {
        ...
        // Core tables
        $logs_table = $wpdb->prefix . (defined('ZICA_AI_LOG_TABLE') ? ZICA_AI_LOG_TABLE : 'cfrdm_logs');
        $news_table = $wpdb->prefix . (defined('ZICA_AI_NEWS_TABLE') ? ZICA_AI_NEWS_TABLE : 'cfrdm_news');
