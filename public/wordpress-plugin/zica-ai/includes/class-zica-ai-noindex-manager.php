...
class ZICA_AI_Noindex_Manager {
    ...
    public function register_routes() {
        register_rest_route( 'zica-ai/v1', '/noindex-manager', array(
            'methods'             => 'POST',
            'callback'            => array( $this, 'handle_noindex_request' ),
            'permission_callback' => array( $this, 'check_permission' ),
        ) );

        register_rest_route( 'zica-ai/v1', '/noindex-manager/status', array(
            'methods'             => 'GET',
    ...
    public function check_permission( $request ) {
        ...
        if ( $api_key && $api_key === get_option( 'zica_ai_api_key' ) ) {
            return true;
        }
    ...
    public function handle_noindex_request( $request ) {
        ...
        if ( $results['total_applied'] > 0 && class_exists( 'ZICA_AI_Logger' ) ) {
