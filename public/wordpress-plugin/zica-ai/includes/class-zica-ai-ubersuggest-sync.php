...
class ZICA_AI_Ubersuggest_Sync {
    ...
    public function init() {
        ...
        // Schedule weekly sync (using custom interval from ZICA_AI_Cron_Scheduler)
    ...
    public function import_broken_urls_csv($file_path) {
        ...
        ZICA_AI_Logger::success('ubersuggest', 'CSV importado', array(
            'imported' => $imported,
            'skipped' => $skipped,
        ));
    ...
    public function import_backlinks_csv($file_path) {
        ...
        ZICA_AI_Logger::success('ubersuggest', 'Backlinks importados', array(
            'imported' => $imported,
        ));
    ...
    public function sync_data() {
        ...
        if (empty($api_key)) {
            ZICA_AI_Logger::info('ubersuggest', 'Sync ignorado - API key não configurada');
            return;
        }
        ...
        ZICA_AI_Logger::info('ubersuggest', 'Para importar dados do Ubersuggest, use a importação manual de CSV');
    ...
    public static function handle_csv_upload() {
        ...
        $temp_path = $upload_dir['basedir'] . '/zica-ai-temp-' . time() . '.csv';
