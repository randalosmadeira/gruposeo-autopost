...
class ZICA_AI_Social_Admin {
    ...
    public static function render() {
        ...
        $accounts = ZICA_AI_Method_Validator::safe_call('ZICA_AI_Social_Poster', 'get_accounts', array(), array());
        ...
        <div class="wrap zica-ai-wrap">
            <h1>
                ...
                <?php _e('Configuração de Redes Sociais', 'zica-ai'); ?>
                <span class="zica-ai-version">v<?php echo ZICA_AI_VERSION; ?></span>
            </h1>
            
            <form method="post" class="zica-ai-social-form">
                ...
                <div class="zica-ai-card">
                    <div class="zica-ai-card-header">
                        <h2>
                            ...
                            <?php _e('Configurações Globais', 'zica-ai'); ?>
                        </h2>
                    </div>
                    <div class="zica-ai-card-body">
                        <div class="zica-ai-form-grid">
                            <div class="zica-ai-form-group">
                                <label>
                                    <input type="checkbox" name="cfrdm_auto_social_post" value="1" 
                                        <?php checked(get_option('cfrdm_auto_social_post'), true); ?> />
                                    <?php _e('Auto-postar em redes sociais ao publicar artigo', 'zica-ai'); ?>
                                </label>
                                <p class="description">
                                    <?php _e('Quando ativado, artigos serão automaticamente adicionados à fila social ao serem publicados.', 'zica-ai'); ?>
                                </p>
                            </div>
                            
                            <div class="zica-ai-form-group">
                                <label for="cfrdm_social_delay"><?php _e('Atraso entre posts (minutos)', 'zica-ai'); ?></label>
                                ...
                                <p class="description">
                                    <?php _e('Tempo de espera entre posts em diferentes plataformas.', 'zica-ai'); ?>
                                </p>
                            </div>
                            
                            <div class="zica-ai-form-group">
                                <label for="cfrdm_social_template"><?php _e('Template Padrão de Post', 'zica-ai'); ?></label>
                                <textarea id="cfrdm_social_template" name="cfrdm_social_template" rows="3"
                                    placeholder="📢 {title}&#10;&#10;{excerpt}&#10;&#10;🔗 {url}"
                                ><?php echo esc_textarea($settings['default_template'] ?? "📢 {title}\n\n{excerpt}\n\n🔗 {url}"); ?></textarea>
                                <p class="description">
                                    <?php _e('Use: {title}, {excerpt}, {url}, {author}, {category}, {tags}', 'zica-ai'); ?>
                                </p>
                            </div>
                            ...
                            <div class="zica-ai-form-group">
                                <label>
                                    ...
                                    <?php _e('Incluir imagem destacada nos posts', 'zica-ai'); ?>
                                </label>
                            </div>
                            ...
                            <div class="zica-ai-form-group">
                                <label>
                                    ...
                                    <?php _e('Gerar hashtags automaticamente das tags do post', 'zica-ai'); ?>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="zica-ai-card">
                    <div class="zica-ai-card-header">
                        <h2>
                            ...
                            <?php _e('Contas Conectadas', 'zica-ai'); ?>
                        </h2>
                        <button type="button" class="button" id="zica-ai-add-account">
                            <span class="dashicons dashicons-plus-alt"></span>
                            <?php _e('Adicionar Conta', 'zica-ai'); ?>
                        </button>
                    </div>
                    <div class="zica-ai-card-body">
                        ...
                        <div class="zica-ai-empty-state">
                            ...
                            <p><?php _e('Nenhuma conta configurada.', 'zica-ai'); ?></p>
                            <p class="description"><?php _e('Clique em "Adicionar Conta" para conectar suas redes sociais.', 'zica-ai'); ?></p>
                        </div>
                        <?php else: ?>
                        <div class="zica-ai-accounts-grid">
                            <?php foreach ($accounts as $account): 
                                $platform = self::PLATFORMS[$account['platform']] ?? null;
                                if (!$platform) continue;
                            ?>
                            <div class="zica-ai-account-card" data-account-id="<?php echo esc_attr($account['id']); ?>">
                                ...
                                <div class="account-body">
                                    ...
                                    <p class="account-stats">
                                        <span><?php printf(__('%d posts', 'zica-ai'), $account['posts_count'] ?? 0); ?></span>
                                ...
                                <div class="account-actions">
                                    <button type="button" class="button button-small zica-ai-edit-account" 
                                        data-account-id="<?php echo esc_attr($account['id']); ?>">
                                        <span class="dashicons dashicons-edit"></span>
                                    </button>
                                    <button type="button" class="button button-small zica-ai-toggle-account" 
                                        data-account-id="<?php echo esc_attr($account['id']); ?>"
                                    ...
                                    <button type="button" class="button button-small button-link-delete zica-ai-delete-account" 
                                        data-account-id="<?php echo esc_attr($account['id']); ?>">
                ...
                <div class="zica-ai-platforms-grid">
                    <?php foreach (self::PLATFORMS as $platform_key => $platform): ?>
                    <div class="zica-ai-card zica-ai-platform-card">
                        <div class="zica-ai-card-header" style="background: linear-gradient(135deg, <?php echo esc_attr($platform['color']); ?>20, <?php echo esc_attr($platform['color']); ?>10);">
                            <h2>
                            ...
                            <label class="zica-ai-switch">
                                ...
                                <span class="zica-ai-slider"></span>
                            </label>
                        </div>
                        <div class="zica-ai-card-body zica-ai-platform-fields" data-platform="<?php echo esc_attr($platform_key); ?>">
                ...
                <div class="zica-ai-card">
                    <div class="zica-ai-card-header">
                        <h2>
                            ...
                            <?php _e('Status da Fila Social', 'zica-ai'); ?>
                        </h2>
                        <button type="button" class="button" id="zica-ai-process-social-queue">
                            <span class="dashicons dashicons-controls-play"></span>
                            <?php _e('Processar Agora', 'zica-ai'); ?>
                        </button>
                    </div>
                    <div class="zica-ai-card-body">
                        <?php 
                        $queue_stats = ZICA_AI_Method_Validator::safe_call('ZICA_AI_Social_Poster', 'get_queue_stats', array(), array());
                        ?>
                        <div class="zica-ai-queue-stats">
                            ...
                            <div class="stat-item processing">
                                ...
                                <span class="stat-label"><?php _e('Processando', 'zica-ai'); ?></span>
                            </div>
                            <div class="stat-item completed">
                                <span class="stat-value"><?php echo number_format_i18n($queue_stats['posted'] ?? 0); ?></span>
                                <span class="stat-label"><?php _e('Postados', 'zica-ai'); ?></span>
                            </div>
                            <div class="stat-item failed">
                                <span class="stat-value"><?php echo number_format_i18n($queue_stats['failed'] ?? 0); ?></span>
                                <span class="stat-label"><?php _e('Falhas', 'zica-ai'); ?></span>
                            </div>
                        </div>
                        
                        <!-- Recent Queue Items -->
                        <?php 
                        $recent_items = ZICA_AI_Method_Validator::safe_call('ZICA_AI_Social_Poster', 'get_queue_items', array(array('limit' => 10)), array());
                        if (!empty($recent_items)):
                        ?>
                        <table class="wp-list-table widefat fixed striped" style="margin-top: 20px;">
                            <thead>
                                <tr>
                                    <th><?php _e('Plataforma', 'zica-ai'); ?></th>
                                    <th><?php _e('Post', 'zica-ai'); ?></th>
                                    <th><?php _e('Status', 'zica-ai'); ?></th>
                                    <th><?php _e('Agendado', 'zica-ai'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="zica-ai-status-badge <?php echo esc_attr($item->status); ?>">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="button button-small zica-ai-retry-social" 
                                            data-id="<?php echo esc_attr($item->id); ?>">
                                            <span class="dashicons dashicons-update"></span>
                                        </button>
                                        <?php endif; ?>
                                        <button type="button" class="button button-small button-link-delete zica-ai-cancel-social" 
                                            data-id="<?php echo esc_attr($item->id); ?>">
                ...
                <!-- Save Button -->
                <div class="zica-ai-actions" style="margin-top: 24px;">
        ...
        <!-- Add Account Modal -->
        <div id="zica-ai-account-modal" class="zica-ai-modal" style="display: none;">
            <div class="zica-ai-modal-content">
                <div class="zica-ai-modal-header">
                    <h3><?php _e('Adicionar Conta', 'zica-ai'); ?></h3>
                    <button type="button" class="zica-ai-modal-close">&times;</button>
                </div>
                <div class="zica-ai-modal-body">
                    <div class="zica-ai-form-group">
                        <label for="account-platform"><?php _e('Plataforma', 'zica-ai'); ?></label>
                    ...
                    <div class="zica-ai-form-group">
                        <label for="account-name"><?php _e('Nome da Conta', 'zica-ai'); ?></label>
                ...
                <div class="zica-ai-modal-footer">
                    <button type="button" class="button" id="zica-ai-modal-cancel"><?php _e('Cancelar', 'zica-ai'); ?></button>
                    <button type="button" class="button button-primary" id="zica-ai-save-account"><?php _e('Salvar Conta', 'zica-ai'); ?></button>
                </div>
            </div>
        </div>
        ...
        jQuery(document).ready(function($) {
            // Modal handling
            $('#zica-ai-add-account').on('click', function() {
                $('#zica-ai-account-modal').fadeIn(200);
                updateCredentialFields();
            });
            
            $('.zica-ai-modal-close, #zica-ai-modal-cancel').on('click', function() {
                $('#zica-ai-account-modal').fadeOut(200);
            });
            ...
            function updateCredentialFields() {
                ...
                platformFields.forEach(function(field) {
                    ...
                    html += '<div class="zica-ai-form-group">';
            ...
            // Save account
            $('#zica-ai-save-account').on('click', function() {
                var $btn = $(this);
                var data = {
                ...
                $btn.prop('disabled', true).text('<?php _e('Salvando...', 'zica-ai'); ?>');
                
                $.post(ajaxurl, data, function(response) {
                    if (response.success) {
                        location.reload();
                    } else {
                        alert(response.data || '<?php _e('Erro ao salvar conta', 'zica-ai'); ?>');
                        $btn.prop('disabled', false).text('<?php _e('Salvar Conta', 'zica-ai'); ?>');
                    }
                });
            });
            
            // Process queue
            $('#zica-ai-process-social-queue').on('click', function() {
                var $btn = $(this);
                ...
                $.post(ajaxurl, {
                    ...
                    if (response.success) {
                        alert(response.data.message || '<?php _e('Fila processada!', 'zica-ai'); ?>');
                        location.reload();
                    } else {
                        alert(response.data || '<?php _e('Erro ao processar fila', 'zica-ai'); ?>');
                    }
    ...
    private static function render_platform_fields($platform_key, $platform, $settings) {
        ...
        <div class="zica-ai-form-group">
            <label>
                ...
                <?php _e('Incluir link do artigo', 'zica-ai'); ?>
            </label>
        </div>
        <?php
    }
    ...
    public static function ajax_save_account() {
        ...
        $result = ZICA_AI_Method_Validator::safe_call('ZICA_AI_Social_Poster', 'add_account', array(array(
            'network' => $platform,
    ...
    public static function ajax_process_queue() {
        ...
        $result = ZICA_AI_Method_Validator::safe_call('ZICA_AI_Social_Poster', 'process_queue', array(10), array('processed' => 0));
        
        wp_send_json_success(array(
            'message' => sprintf(__('%d posts processados', 'zica-ai'), $result['processed'] ?? 0),
            'result' => $result,
        ));
    }
}
