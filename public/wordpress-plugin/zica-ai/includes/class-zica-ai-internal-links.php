...
class ZICA_AI_Internal_Links {
    ...
    public function register_rest_routes() {
        register_rest_route('zica-ai/v1', '/analyze-internal-links', array(
            'methods' => 'POST',
            'callback' => array($this, 'rest_analyze_links'),
            'permission_callback' => array($this, 'check_permission'),
        ));
        
        register_rest_route('zica-ai/v1', '/generate-internal-links', array(
            'methods' => 'POST',
            'callback' => array($this, 'rest_generate_links'),
            'permission_callback' => array($this, 'check_permission'),
        ));
        
        register_rest_route('zica-ai/v1', '/link-suggestions', array(
            'methods' => 'GET',
