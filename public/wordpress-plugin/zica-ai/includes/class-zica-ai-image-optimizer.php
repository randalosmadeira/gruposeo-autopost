...
class ZICA_AI_Image_Optimizer {
    ...
    public static function optimize_on_upload($attachment_id) {
        ...
        if ($result['success']) {
            ZICA_AI_Logger::success('image', 'Imagem otimizada no upload', array(
    ...
    public static function bulk_optimize($limit = 50, $offset = 0) {
        ...
        ZICA_AI_Logger::info('image', 'Otimização em massa executada', $results);
    ...
    public static function generate_featured_image_placeholder($post_id, $title) {
        ...
        ZICA_AI_Logger::warning('image', 'Artigo sem imagem destacada', array(
            'post_id' => $post_id,
            'title' => $title,
        ), $post_id);
    ...
    public static function fix_social_image($attachment_id) {
        ...
        ZICA_AI_Logger::success('image', 'Imagem social criada', array(
            'attachment_id' => $attachment_id,
