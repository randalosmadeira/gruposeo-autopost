...
class ZICA_AI_Post_Duplicator {
    ...
    public function handle_bulk_action($redirect_to, $action, $post_ids) {
        ...
        if ($action === 'cfrdm_bulk_delete') {
            ...
            ZICA_AI_Logger::success('duplicator', 'Exclusão em lote', array(
                'deleted' => $count,
            ));
        }
    ...
    public function duplicate_post($post_id, $overrides = array()) {
        ...
        ZICA_AI_Logger::success('duplicator', 'Post duplicado', array(
            'source_id' => $post_id,
            'new_id' => $new_id,
        ...
        if (class_exists('ZICA_AI_Meta_Auditor')) {
            ZICA_AI_Meta_Auditor::get_instance()->audit_single_post($new_id);
        }
    ...
    public function register_rest_routes() {
        register_rest_route('zica-ai/v1', '/duplicate/(?P<id>\d+)', array(
            'methods' => 'POST',
