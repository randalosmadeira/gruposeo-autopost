...
class ZICA_AI_Social_Poster {
    ...
    public static function create_tables() {
        ...
        ZICA_AI_Logger::success('social_poster', 'Tabelas de social posting criadas/atualizadas');
    }
    ...
    public static function add_account($data) {
        ...
        if ($result === false) {
            ZICA_AI_Logger::error('social_poster', 'Falha ao adicionar conta social', array(
        ...
        ZICA_AI_Logger::success('social_poster', 'Conta social adicionada', array(
            'id' => $wpdb->insert_id,
            'network' => $data['network'],
    ...
    public static function queue_post($post_id, $account_id, $options = array()) {
        ...
        ZICA_AI_Logger::info('social_poster', 'Post adicionado à fila social', array(
    ...
    public static function process_queue($limit = 10) {
        ...
        if ($results['processed'] > 0) {
            ZICA_AI_Logger::info('social_poster', 'Fila processada', $results);
        }
    ...
    public static function cleanup($days = 30) {
        ...
        if ($deleted > 0) {
            ZICA_AI_Logger::info('social_poster', "Limpeza: {$deleted} itens removidos da fila");
        }
