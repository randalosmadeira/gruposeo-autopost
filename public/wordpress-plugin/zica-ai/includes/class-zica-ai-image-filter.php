    ...
    public static function filter_images($images, $options = array()) {
        ...
        foreach ($images as $image) {
            ...
            if ($options['avoid_logo'] && self::is_likely_logo($url)) {
                ZICA_AI_Logger::info('image_filter', 'Imagem ignorada (padrão de logo)', array(
                    'url' => $url,
                ));
                continue;
            }
            ...
            if ($options['check_dimensions']) {
                ...
                if ($dimensions && (
                    ...
                    ZICA_AI_Logger::info('image_filter', 'Imagem ignorada (dimensões insuficientes)', array(
                        'url' => $url,
