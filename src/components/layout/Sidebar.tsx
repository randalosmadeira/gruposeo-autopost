...
import { Activity, Calendar, ChevronDown, Crown, FileEdit, FileText, FolderKanban, Globe2, GraduationCap, History, Layers, LayoutDashboard, MessageSquare, Newspaper, Plug, Settings, Target, User, Users, Vote, Zap } from 'lucide-react';
...
const navGroups: NavGroup[] = [
  ...
  { title: 'Geração', items: [{ label: 'Ondas de Conteúdo', icon: Zap, href: '/articles/bulk', subItems: [{ label: 'Artigo', icon: FileText, href: '/articles/types' }, { label: 'Repostagem', icon: FileEdit, href: '/news-rewriter' }, { label: 'Eleitoral', icon: Vote, href: '/electoral-campaign', badge: 'Novo' }, { label: 'Central Eleitoral', icon: History, href: '/electoral-campaign/editorial-console', badge: 'Operar' }, { label: 'Base de Apoiadores', icon: Users, href: '/electoral-campaign/supporters', badge: 'Privado' }, { label: 'Rede Eleitoral', icon: Globe2, href: '/electoral-campaign/portal-network', badge: 'Novo' }, { label: 'Palavras-chave em Massa', icon: Layers, href: '/keywords/bulk', badge: 'Pro' }, { label: 'Histórico Geral', icon: History, href: '/articles' }] }] },
