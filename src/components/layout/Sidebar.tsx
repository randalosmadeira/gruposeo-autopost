...
import { Activity, Calendar, ChevronDown, Crown, FileEdit, FileText, FolderKanban, Globe2, GraduationCap, History, Layers, LayoutDashboard, MessageSquare, Newspaper, Plug, Settings, Target, User, Vote, Zap } from 'lucide-react';
